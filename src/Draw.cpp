...
//        init();
    ...
    void init() {
        ...
        gladLoadGL();
        gladLoadGLLoader((GLADloadproc)glfwGetProcAddress);  // new code
...
//                    0.5F, 0.6F, 0.5F,
//            };
            glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_DYNAMIC_DRAW); //GL_STREAM_DRAW  //GL_STATIC_DRAW
            //dynamic stop
